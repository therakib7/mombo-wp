 ...
 * @since 1.0
 */
function mombo_get_standard_fonts() {
	return apply_filters(
		'mombostandard_fonts_array', array(
 ...
 * @since 1.0
 */
function mombo_enqueue_google_font( $font ) {
	...
	$subsets     = '';
	$get_subsets = mombo_get_options( array('font_subsets', array( 'latin' ) ) );
	...
	// Weights
	$weights = apply_filters( 'mombo_font_weights', array( '300', '400', '500', '600', '700', '800' ) );
	...
	// Enqueue style
	wp_enqueue_style( 'mombo-google-font-' . $handle, $url, array(), false );
}