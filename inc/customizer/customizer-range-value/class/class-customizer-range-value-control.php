 ...
 * @access public
 */
class Mombo_Customizer_Range_Value_Control extends WP_Customize_Control {
	...
	/**
	 * Mombo_Customizer_Range_Value_Control constructor.
	 *
 ...
 * @since 1.0
 */
function mombo_sanitize_range_value( $input ) {
	if ( mombois_json( $input ) ) {
