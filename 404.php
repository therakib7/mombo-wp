...
<section class="dark-bg">
    <div class="container">
        <div class="row justify-content-center full-screen align-items-center section">
            <div class="col-lg-8 text-center">
                ...
                <div class="m-30px-tb">
                    <img src="<?php echo esc_url( get_theme_file_uri('/assets/img/effect/404-page.svg') ) ?>" title="" alt="">
                </div>
                <div>
